    ...
    <View style={styles.container}>
      ...
      <View style={styles.text}>
        ...
        <Text>
          ...
          persyaratan yang berlaku pada Bank dan telah menandatangani dokumen
          yang diperlukan Bank dalam pemberian kredit.
        </Text>
      </View>
      <View style={styles.text}>
        <Text>4. </Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("NotificationSuccess")}
      >
        <Text
          style={{
            textAlign: "center",
