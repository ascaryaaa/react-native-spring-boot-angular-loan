...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Mar 2024 pada 11.27
...
CREATE TABLE `account` (
  ...
  `hashed_id_account` varchar(255) DEFAULT NULL
...
INSERT INTO `account` (`account_id`, `mpin_account`, `username_account`, `id_user`, `hashed_id_account`) VALUES
(1, '123456', 'SarahJ', 1, NULL);
...
CREATE TABLE `form_pengajuan` (
  ...
  `hashed_id_form_pengajuan_pinjaman` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `form_pengajuan` (`id_form_pengajuan_pinjaman`, `alamat_ktp_user_form_pengajuan_pinjaman`, `angsuran_per_bulan_form_pengajuan_pinjaman`, `harga_rumah_form_pengajuan_pinjaman`, `jangka_waktu_form_pengajuan_pinjaman`, `jenis_kelamin_form_pengajuan_pinjaman`, `jumlah_pinjaman_form_pengajuan_pinjaman`, `kecamatan_form_pengajuan_pinjaman`, `kelurahan_user_form_pengajuan_pinjaman`, `kode_pos_form_pengajuan_pinjaman`, `maks_angsuran_griya`, `npwp_form_pengajuan_pinjaman`, `penghasilan_bersih_per_bulan_form_pengajuan_pinjaman`, `persentase_uang_muka_form_pengajuan_pinjaman`, `status_form_pengajuan_pinjaman`, `tanggal_lahir_form_pengajuan_pinjaman`, `tanggal_realisasi_pinjaman`, `tempat_lahir_form_pengajuan_pinjaman`, `uang_muka_form_pengajuan_pinjaman`, `id_admin`, `id_jenis_pinjaman`, `id_user`, `id_cabang`, `cif`, `hashed_id_form_pengajuan_pinjaman`) VALUES
(1, '123 Main Stree', 5400877, 1500000000, 360, 'Male', 0, 'Central District', 'Downtown', '12345', 0, '1234567890987654', 30000000, 10, 'Diterima', '1990-05-20', '2024-03-22 14:09:24.000000', 'Surabaya', NULL, 1, 1, 1, 45, NULL, NULL),
(2, '456 Oak Avenue', 20000000, 1800000000, 120, 'Male', 0, 'Suburbia', 'Green Heights', '54321', NULL, '9876543210123456', 35000000, 15, 'Ditolak', '1985-10-15', NULL, 'Jakarta', 200000000, 1, 1, 4, 20, NULL, NULL),
(3, '789 Elm Street', 18000000, NULL, 180, 'Female', 200000000, 'Riverside', 'Riverfront', '67890\r\n', NULL, '5432109876543210', 40000000, 20, 'Diterima', '1978-03-25', '2024-03-22 14:09:52.000000', 'Bandung', 20000000, 2, 2, 5, 10, NULL, NULL),
(4, '123 Main Stree', 15000000, 1500000000, 360, 'Male', 0, 'Central District', 'Downtown', '12345', 2312680237.4792953, '1234567890987654', 30000000, 10, 'Ditolak', '1990-05-20', NULL, 'Surabaya', NULL, 2, 1, 1, 45, NULL, NULL),
(5, '456 Oak Avenue', 17500000, 1800000000, 120, 'Male', 0, 'Suburbia', 'Green Heights', '54321', 1524070103.209989, '9876543210123456', 35000000, 15, 'Diproses', '1985-10-15', '2024-03-22 16:42:48.000000', 'Jakarta', 200000000, 2, 1, 4, 20, NULL, NULL),
(6, '456 Oak Avenue', 17500000, 1800000000, 120, 'Male', 0, 'Suburbia', 'Green Heights', '54321', 1524070103.209989, '9876543210123456', 35000000, 15, 'Diproses', '1985-10-15', '2024-03-24 17:06:20.000000', 'Jakarta', 200000000, 1, 1, 4, 20, NULL, NULL),
(7, '789 Elm Street', 20000000, NULL, 180, 'Female', 200000000, 'Riverside', 'Riverfront', '67890\r\n', 1601490056.638619, '5432109876543210', 40000000, 20, 'Diterima', '1978-03-25', '2024-03-24 17:07:25.000000', 'Bandung', 20000000, 1, 2, 5, 10, NULL, NULL),
(8, '789 Elm Street', 20000000, NULL, 180, 'Female', 200000000, 'Riverside', 'Riverfront', '67890\r\n', 1601490056.638619, '5432109876543210', 40000000, 20, 'Ditolak', '1978-03-25', NULL, 'Bandung', 20000000, 3, 2, 5, 10, NULL, NULL),
(9, '789 Elm Street', 20000000, NULL, 180, 'Female', 200000000, 'Riverside', 'Riverfront', '67890\r\n', 1601490056.638619, '5432109876543210', 40000000, 20, 'Diproses', '1978-03-25', NULL, 'Bandung', 20000000, NULL, 2, 5, 10, NULL, NULL);
...
CREATE TABLE `pinjaman` (
  ...
  `hashed_id_pinjaman` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pinjaman` (`id_pinjaman`, `amounts_bunga_berjalan_pinjaman`, `amounts_sisa_pokok_pinjaman`, `deskripsi_pembayaran_pinjaman`, `kolektabilitas_pinjaman`, `name_user`, `nik_user`, `payoffs_bunga_berjalan_pinjaman`, `payoffs_sisa_pokok_pinjaman`, `rebates_bunga_berjalan_pinjaman`, `rebates_sisa_pokok_pinjaman`, `sisa_tagihan_pinjaman`, `status_tagihan_pinjaman`, `tanggal_bayar_tagihan_pinjaman`, `total_amounts_pinjaman`, `total_bayar_tagihan_pinjaman`, `total_payoffs_pinjaman`, `total_rebates_pinjaman`, `id_form_pengajuan_pinjaman`, `hashed_id_pinjaman`) VALUES
(73, 3000000, 150000000, 'test', NULL, NULL, NULL, 2500000, 145000000, 500000, 5000000, 140000000, 'Hijau', NULL, 200000000, 60000000, 150000000, 10000000, 1, NULL),
(74, NULL, NULL, 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Hijau', NULL, NULL, NULL, NULL, NULL, 3, NULL),
(77, NULL, NULL, 'test', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Hijau', NULL, NULL, NULL, NULL, NULL, 7, 'fc313ae2ce98cd4a6f0f3022ed4dcb779b912d26173c8063952758c05498b8a6');
...
--
ALTER TABLE `form_pengajuan`
  MODIFY `id_form_pengajuan_pinjaman` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `pinjaman`
  MODIFY `id_pinjaman` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
